...
- React-интерфейс: чат с агентом, фильтры кейсов, история, вложения,
  ссылки в сообщениях и выбор темы.
...
При локальном запуске Vite UI доступен на `http://localhost:5173`.
